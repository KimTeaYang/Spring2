...
//@ImportResource({"classpath:ex08/appContext.xml","b.xml"})  //여러개일 경우 배열로
@ImportResource("classpath:ex08/appContext.xml")
public class Config {
	@Autowired
	private Emp exmlBean;
